...
results = []
# Extract the text from all result files 
...
summaries = []
# Extract the text from all summary files 
...
f_all = open(score_dir + "all_scores_scisumm_2018.txt", "w+", encoding="utf-8")
f_mean = open(score_dir + "mean_scores_scisumm_2018.txt", "w+", encoding="utf-8")
